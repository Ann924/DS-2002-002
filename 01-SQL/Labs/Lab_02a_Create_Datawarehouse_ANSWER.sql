...
CREATE TABLE `fact_orders`(
  ...
  `product_key` int DEFAULT NULL, #<-- from order_details
  ...
  `order_status` varchar(50) NOT NULL, # <- from orders_status
  
  # from order_details
  `quantity` decimal(18,4) NOT NULL DEFAULT '0.0000',
  `unit_price` decimal(19,4) DEFAULT '0.0000',
  `discount` double NOT NULL DEFAULT '0',
  `order_details_status` varchar(50) NOT NULL,	# from order_details_status
